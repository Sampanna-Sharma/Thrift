...
var d = chrome.runtime.getURL("images/get_started16.png");
var d2 = chrome.runtime.getURL("images/get_started16.png");
...
$(document).on('click','.this-is-my-image',function(){
    ...
    */
    xhr.open("GET","http://35.173.235.215:5000/?ProductName="+title);
...
setInterval(function(){
    ...
    */
    var posts = document.getElementsByClassName('sg-col-4-of-12 sg-col-8-of-16 sg-col-16-of-24 sg-col-12-of-20 sg-col-24-of-32 sg-col sg-col-28-of-36 sg-col-20-of-28');
  ...
  //rakhne class a-row a-size-base a-color-base
...
*/
        ...
        */
        var data = post.getElementsByClassName('a-size-medium a-color-base a-text-normal')[0];
        console.log(data)
        if(data)
        {
...
function createROW(post,title){
    ...
    */
    var datas = post.getElementsByClassName('a-row a-size-base a-color-base');
    console.log('datas')
    /*
